...
- Wed 8/28/13:
    ...
    7.   Store the code in git and allow me to track your progress via git.  After you create the repository, give me directions
how to clone it, and then make periodic commits as you work on the project.
